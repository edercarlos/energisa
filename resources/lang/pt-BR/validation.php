...
return [
    ...
    */
    'custom' => [
        'cpf_cnpj' => [
            'regex' => 'O formato do campo CPF / CNPJ está incorreto.',
        ],
		'nome' => [
            'regex' => 'O formato do campo Nome está incorreto. São aceitos apenas caracteres alfabéticos, \'%\' e \'_\'',
        ],
		'municipio' => [
            'regex' => 'O formato do campo Nome está incorreto. São aceitos apenas caracteres alfabéticos, \'%\' e \'_\'',
        ],
		...
		'logradouro' => [
            'regex' => 'O formato do campo Nome está incorreto. São aceitos apenas caracteres alfanuméricos, \'%\' e \'_\'',
        ],
		'cep' => [
            'max' => 'O campo CEP não pode possuir mais que :max caracteres.',
            'regex' => 'O formato do campo CEP está incorreto.',
        ],
    ],
    /*
    |--------------------------------------------------------------------------
